...
case
when PK1.ORG = '200' then substr(PK1.CUENTA,1,9) ||''||'******'||''|| substr(PK1.CUENTA,16,4)
when PK1.ORG = '210' then substr(PK1.CUENTA,1,11) ||''||'****'||''|| substr(PK1.CUENTA,16,4)
else '0'
end as CUENTA,
